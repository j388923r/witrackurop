//
//  SlideDownNavigationSegue.swift
//  WiTrackApp
//
...
class SlideDownNavigationSegue: UIStoryboardSegue {
    
    override func perform() {
        
        // Assign the source and destination views to local variables.
        let firstVC = self.sourceViewController
        let navVC = self.destinationViewController as! UINavigationController
        let secondVC = navVC.topViewController!
